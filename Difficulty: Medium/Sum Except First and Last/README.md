<h2><a href="https://www.geeksforgeeks.org/problems/max-length-chain/1?page=1&difficulty=Medium&status=unsolved&sortBy=submissions">Sum Except First and Last</a></h2><h3>Difficulty Level : Difficulty: Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">You are given an array <strong>arr</strong> of numbers. Return the sum of all the elements except the first and last elements.</span></p>
