<h2><a href="https://www.geeksforgeeks.org/problems/check-if-tree-is-isomorphic/1?page=1&difficulty=Medium&status=unsolved&sortBy=submissions">Check if Tree is Isomorphic</a></h2><h3>Difficulty Level : Difficulty: Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">Given two&nbsp;Binary Trees. Check whether they are&nbsp;Isomorphic or not.</span></p>
