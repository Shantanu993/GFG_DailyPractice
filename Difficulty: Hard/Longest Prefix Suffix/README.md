<h2><a href="https://www.geeksforgeeks.org/problems/longest-prefix-suffix2527/1?page=1&difficulty=Hard&status=unsolved&sortBy=submissions">Longest Prefix Suffix</a></h2><h3>Difficulty Level : Difficulty: Hard</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">Given a string of characters, find the length of the longest proper prefix which is also a proper suffix.</span></p>
